...
pop_sound = pygame.mixer.Sound('party-balloon-pop-323588.mp3')
background_music = pygame.mixer.Sound('circus-music-loop-362929.mp3')
...
background_image = pygame.image.load('4156248.jpg').convert()
background = pygame.transform.scale(background_image, (SCREEN_WIDTH, SCREEN_HEIGHT))

balloon_image = pygame.image.load('balloon-1111368_1280.png').convert_alpha()
