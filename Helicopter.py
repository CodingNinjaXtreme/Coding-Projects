...
high_score = 0
active = True
heli = pygame.transform.scale(pygame.image.load('../image/helicopter.png'), (60, 60))
pygame.mixer_music = pygame.mixer.Sound('../image/mixkit-air-traffic-ambience-with-helicopter-2714.wav')
pygame.mixer_music.play(-1)


def draw_sky_elements():
    # Draw sun (yellow ellipse)
    pygame.draw.ellipse(screen, (255, 223, 0), (800, 50, 100, 100))  # sun

    # Draw clouds (white ellipses)
    pygame.draw.ellipse(screen, (255, 255, 255), (150, 80, 120, 60))
    pygame.draw.ellipse(screen, (255, 255, 255), (200, 60, 140, 80))
    pygame.draw.ellipse(screen, (255, 255, 255), (350, 100, 100, 50))
